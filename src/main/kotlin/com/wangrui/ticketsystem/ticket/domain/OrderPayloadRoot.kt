...
data class OrderPayloadRoot(val encryptedData: String,//不参与加密
    ...
    companion object {
        ...
        fun convertFormData2Object(encryptionParams: EncryptUtils.EncryptionParams,
                                   formData: FormData): OrderPayloadRoot {
...
data class FormData(val agree: Boolean, val id: String, val regions: List<OrderRegion>, val users: List<OrderUser>)

data class OrderRegion(val region: Int,
                       val estate: Int,
                       val num: Int,
                       val name: String,
                       val price: String,
